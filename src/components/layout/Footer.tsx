...
const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/share/176CuPCNyn/',
    icon: (
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/@FirstMillionTrade',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/first_million_trade?igsh=MWdqd2xvODV5c2pkeA==',
    icon: (
                ...
                <div className="flex gap-3">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      className="w-10 h-10 rounded-full bg-muted hover:bg-accent hover:text-accent-foreground flex items-center justify-center text-muted-foreground transition-all duration-300"
                    >
                      {social.icon}
                    </a>
                  ))}
